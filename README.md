## basic_package (kinetic) - 0.0.3-2

The packages in the `basic_package` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release basic_package --track kinetic --rosdistro kinetic` on `Wed, 14 Oct 2020 13:26:03 -0000`
...
## basic_package (kinetic) - 0.0.3-1

The packages in the `basic_package` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release basic_package --track kinetic --rosdistro kinetic` on `Wed, 14 Oct 2020 13:22:06 -0000`
...
## basic_package (tecnalia-kinetic) - 0.0.3-4
